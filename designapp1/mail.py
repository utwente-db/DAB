...
def send_verification(user):
	...
	msg["From"] = send_addr
	msg["To"] = addr
	msg.set_content("Please verify your email for the database management system by visiting https://thebias.nl/verify/"+user["token"])
	cid = make_msgid()
	msg.add_alternative("""\
		<html>
			<body>
				<p>Hello """+user["email"]+""",</p>
				<p>Please verify your email by <a href='https://thebias.nl/verify/"""+user["token"]+"""'> clicking here</a>
				<p>Kind Regards</p>
				<p>group 4</p>
			</body>

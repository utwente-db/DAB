...
:type user: dict
:param created=False: whether the user requested their own account, or the account was created for them
...
"""Send a notice to the user that an account has been created with their email. This account should be verified by then.
...
"""send the password reset email. The token should already be generated by now.
